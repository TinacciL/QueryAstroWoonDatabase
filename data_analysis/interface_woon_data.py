...
import pandas as pd
import numpy as np
from mol_lib import CorrectErrorPwdMolecules, FromHeToKJmol
...
df_molecules = df_molecules[['name','formula','ID','Na','Mass','state_woon','multiplicity_woon','energy(kJ/mol)_woon','spin_input_xtb','energy(kJ/mol)_xtb','pwd_xyz_woon','pwd_xyz_xtb']]

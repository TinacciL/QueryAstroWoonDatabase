...
def isomers_generator(n_h,n_c,n_n,n_o):
	'''
	Function that take as input the number of: H,C,N,O and gives it back the tree of the generation of all the possibile molecules. This last one are the leafs of the tree. 
	'''
	H = Atom(("H",1,1,1,1))
	C = Atom(("C",4,4,4,4))
	N = Atom(("N",5,5,4,4))

...
echo ${OAR_JOB_ID} == $(date) == C3O_2X_t6.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_todo/test_bi/t6
MY_OUTPUT_DIR=/home/tinaccil/mol_todo/test_bi/t6
MY_INPUT_FILE=C3O_2X_t6.com
MY_OUTPUT_FILE=C3O_2X_t6.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_C3O_2X_t6
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.C3O_2X_t6
cd ${MY_OUTPUT_DIR}

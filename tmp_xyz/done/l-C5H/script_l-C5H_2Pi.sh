...
#OAR -O G16.%jobid%.o
#OAR -E G16.%jobid%.e
#OAR -l /nodes=1/core=24,walltime=10:00:00
...
echo ${OAR_JOB_ID} == $(date) == l-C5H_2Pi.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_todo/l-C5H
MY_OUTPUT_DIR=/home/tinaccil/mol_todo/l-C5H
MY_INPUT_FILE=l-C5H_2Pi.com
MY_OUTPUT_FILE=l-C5H_2Pi.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_l-C5H_2Pi
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.l-C5H_2Pi
cd ${MY_OUTPUT_DIR}

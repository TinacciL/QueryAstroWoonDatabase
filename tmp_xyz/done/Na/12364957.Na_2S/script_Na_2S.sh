...
echo ${OAR_JOB_ID} == $(date) == Na_2S.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_todo/Na
MY_OUTPUT_DIR=/home/tinaccil/mol_todo/Na
MY_INPUT_FILE=Na_2S.com
MY_OUTPUT_FILE=Na_2S.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_Na_2S
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.Na_2S
cd ${MY_OUTPUT_DIR}

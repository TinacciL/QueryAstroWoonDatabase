...
echo ${OAR_JOB_ID} == $(date) == C6H10_1Ap.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_todo/C6H10
MY_OUTPUT_DIR=/home/tinaccil/mol_todo/C6H10
MY_INPUT_FILE=C6H10_1Ap.com
MY_OUTPUT_FILE=C6H10_1Ap.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_C6H10_1Ap
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.C6H10_1Ap
cd ${MY_OUTPUT_DIR}

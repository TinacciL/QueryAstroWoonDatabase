...
echo ${OAR_JOB_ID} == $(date) == C3H7_2X.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_todo/C3H7_2X
MY_OUTPUT_DIR=/home/tinaccil/mol_todo/C3H7_2X
MY_INPUT_FILE=C3H7_2X.com
MY_OUTPUT_FILE=C3H7_2X.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_C3H7_2X
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.C3H7_2X
cd ${MY_OUTPUT_DIR}

...
echo ${OAR_JOB_ID} == $(date) == C7H8_1X.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_todo/C7H8
MY_OUTPUT_DIR=/home/tinaccil/mol_todo/C7H8
MY_INPUT_FILE=C7H8_1X.com
MY_OUTPUT_FILE=C7H8_1X.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_C7H8_1X
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.C7H8_1X
cd ${MY_OUTPUT_DIR}

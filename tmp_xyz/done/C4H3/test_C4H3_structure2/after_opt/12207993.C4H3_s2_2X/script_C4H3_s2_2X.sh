...
echo ${OAR_JOB_ID} == $(date) == C4H3_s2_2X.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_todo/C4H3_s2/after_opt
MY_OUTPUT_DIR=/home/tinaccil/mol_todo/C4H3_s2/after_opt
MY_INPUT_FILE=C4H3_s2_2X.com
MY_OUTPUT_FILE=C4H3_s2_2X.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_C4H3_s2_2X
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.C4H3_s2_2X
cd ${MY_OUTPUT_DIR}

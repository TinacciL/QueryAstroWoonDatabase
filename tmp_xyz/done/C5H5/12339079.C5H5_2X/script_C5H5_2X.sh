...
echo ${OAR_JOB_ID} == $(date) == C5H5_2X.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_todo/C5H5
MY_OUTPUT_DIR=/home/tinaccil/mol_todo/C5H5
MY_INPUT_FILE=C5H5_2X.com
MY_OUTPUT_FILE=C5H5_2X.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_C5H5_2X
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.C5H5_2X
cd ${MY_OUTPUT_DIR}

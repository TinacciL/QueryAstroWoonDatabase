...
#OAR -O G16.%jobid%.o
#OAR -E G16.%jobid%.e
#OAR -l /nodes=1/core=24,walltime=35:00:00
...
echo ${OAR_JOB_ID} == $(date) == C6H10_1X.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_todo/C6H10
MY_OUTPUT_DIR=/home/tinaccil/mol_todo/C6H10
MY_INPUT_FILE=C6H10_1X.com
MY_OUTPUT_FILE=C6H10_1X.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_C6H10_1X
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.C6H10_1X
cd ${MY_OUTPUT_DIR}

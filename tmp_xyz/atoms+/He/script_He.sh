...
echo ${OAR_JOB_ID} == $(date) == He.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/atoms+/He
MY_OUTPUT_DIR=/home/tinaccil/atoms+/He
MY_INPUT_FILE=He.com
MY_OUTPUT_FILE=He.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_He
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.He
cd ${MY_OUTPUT_DIR}

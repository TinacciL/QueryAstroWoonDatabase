...
echo ${OAR_JOB_ID} == $(date) == Cl.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/atoms+/Cl
MY_OUTPUT_DIR=/home/tinaccil/atoms+/Cl
MY_INPUT_FILE=Cl.com
MY_OUTPUT_FILE=Cl.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_Cl
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.Cl
cd ${MY_OUTPUT_DIR}

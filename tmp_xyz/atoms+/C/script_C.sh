...
echo ${OAR_JOB_ID} == $(date) == C.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/atoms+/C
MY_OUTPUT_DIR=/home/tinaccil/atoms+/C
MY_INPUT_FILE=C.com
MY_OUTPUT_FILE=C.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_C
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.C
cd ${MY_OUTPUT_DIR}

...
echo ${OAR_JOB_ID} == $(date) == F.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/atoms+/F
MY_OUTPUT_DIR=/home/tinaccil/atoms+/F
MY_INPUT_FILE=F.com
MY_OUTPUT_FILE=F.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_F
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.F
cd ${MY_OUTPUT_DIR}

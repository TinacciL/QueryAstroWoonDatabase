...
echo ${OAR_JOB_ID} == $(date) == P.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/atoms+/P
MY_OUTPUT_DIR=/home/tinaccil/atoms+/P
MY_INPUT_FILE=P.com
MY_OUTPUT_FILE=P.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_P
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.P
cd ${MY_OUTPUT_DIR}

...
echo ${OAR_JOB_ID} == $(date) == S.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/atoms/S
MY_OUTPUT_DIR=/home/tinaccil/atoms/S
MY_INPUT_FILE=S.com
MY_OUTPUT_FILE=S.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_S
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.S
cd ${MY_OUTPUT_DIR}

...
echo ${OAR_JOB_ID} == $(date) == Mg.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/atoms/Mg
MY_OUTPUT_DIR=/home/tinaccil/atoms/Mg
MY_INPUT_FILE=Mg.com
MY_OUTPUT_FILE=Mg.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_Mg
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.Mg
cd ${MY_OUTPUT_DIR}

...
echo ${OAR_JOB_ID} == $(date) == O.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/atoms/O
MY_OUTPUT_DIR=/home/tinaccil/atoms/O
MY_INPUT_FILE=O.com
MY_OUTPUT_FILE=O.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_O
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.O
cd ${MY_OUTPUT_DIR}

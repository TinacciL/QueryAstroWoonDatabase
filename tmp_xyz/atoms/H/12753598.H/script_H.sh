...
echo ${OAR_JOB_ID} == $(date) == H.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/atoms/H
MY_OUTPUT_DIR=/home/tinaccil/atoms/H
MY_INPUT_FILE=H.com
MY_OUTPUT_FILE=H.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_H
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.H
cd ${MY_OUTPUT_DIR}

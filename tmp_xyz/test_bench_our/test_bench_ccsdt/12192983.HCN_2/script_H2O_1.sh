...
echo ${OAR_JOB_ID} == $(date) == H2O_1.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_bench
MY_OUTPUT_DIR=/home/tinaccil/mol_bench
MY_INPUT_FILE=H2O_1.com
MY_OUTPUT_FILE=H2O_1.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_H2O_1
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.H2O_1
cd ${MY_OUTPUT_DIR}

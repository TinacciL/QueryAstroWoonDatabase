...
echo ${OAR_JOB_ID} == $(date) == HCN_2.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_bench
MY_OUTPUT_DIR=/home/tinaccil/mol_bench
MY_INPUT_FILE=HCN_2.com
MY_OUTPUT_FILE=HCN_2.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_HCN_2
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.HCN_2
cd ${MY_OUTPUT_DIR}

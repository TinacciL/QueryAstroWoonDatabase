...
echo ${OAR_JOB_ID} == $(date) == CH2_3.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_todo/test_bench_roccsdt/CH2
MY_OUTPUT_DIR=/home/tinaccil/mol_todo/test_bench_roccsdt/CH2
MY_INPUT_FILE=CH2_3.com
MY_OUTPUT_FILE=CH2_3.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_CH2_3
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.CH2_3
cd ${MY_OUTPUT_DIR}

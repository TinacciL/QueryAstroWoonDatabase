...
echo ${OAR_JOB_ID} == $(date) == OH_2.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_todo/test_bench_roccsdt/OH
MY_OUTPUT_DIR=/home/tinaccil/mol_todo/test_bench_roccsdt/OH
MY_INPUT_FILE=OH_2.com
MY_OUTPUT_FILE=OH_2.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_OH_2
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.OH_2
cd ${MY_OUTPUT_DIR}

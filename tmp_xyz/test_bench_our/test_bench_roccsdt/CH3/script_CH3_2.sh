...
echo ${OAR_JOB_ID} == $(date) == CH3_2.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_todo/test_bench_roccsdt/CH3
MY_OUTPUT_DIR=/home/tinaccil/mol_todo/test_bench_roccsdt/CH3
MY_INPUT_FILE=CH3_2.com
MY_OUTPUT_FILE=CH3_2.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_CH3_2
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.CH3_2
cd ${MY_OUTPUT_DIR}

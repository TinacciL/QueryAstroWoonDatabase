...
echo ${OAR_JOB_ID} == $(date) == CN_1.com >> /home/tinaccil/launched_jobs.txt
MY_INPUT_DIR=/home/tinaccil/mol_todo/CN1
MY_OUTPUT_DIR=/home/tinaccil/mol_todo/CN1
MY_INPUT_FILE=CN_1.com
MY_OUTPUT_FILE=CN_1.log
...
MY_JOB_SCRATCH_DIR=${MY_SCRATCH_DIR}/${OAR_JOB_ID}_CN_1
...
mv ${MY_JOB_SCRATCH_DIR} ${MY_OUTPUT_DIR}/${OAR_JOB_ID}.CN_1
cd ${MY_OUTPUT_DIR}
